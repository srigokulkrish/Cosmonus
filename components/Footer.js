  ...
  return (
    <footer className="cos-footer">
      ...
      <div className="container">
        ...
        <div className="divider" style={{ marginBottom: 'clamp(2.5rem, 5vw, 3.5rem)' }} />

        {/* Link columns with brand column */}
        <div className="row gy-5">
          ...
          {/* Link columns */}
          {COLUMNS.filter(col => col.head !== 'Socials').map((col) => (
            <div key={col.head} className="col-6 col-md-3 col-lg">
              <h6 className="footer-col-head">{col.head}</h6>
        ...
        <div className="footer-bottom">
          <div>© {year} Cosmonus. All rights reserved.</div>
