...
// The original cosmonus.com pairing: Schibsted Grotesk for everything, JetBrains Mono for labels. Upright only:
// nothing on the site is set in italic, and the italic face was a 50 KB preload on every page for no glyph.
const grotesk = Schibsted_Grotesk({ subsets: ["latin"], weight: ["400", "500", "600"], style: ["normal"], variable: "--font-grotesk", display: "swap" });
